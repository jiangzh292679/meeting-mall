...
import com.stylefeng.guns.rest.modular.system.cache.ICache;
...
import com.stylefeng.guns.rest.modular.system.util.CurrentUserUtils;
...
public class UserController {
    ...
    public ServerResponse<String> logout(HttpSession session){
        ...
        iCache.removeCache(user.getUsername());
